...
async function loadCatalogue() {
  ...
  try {
    ...
    document.querySelectorAll('#brand-cards [data-bid]').forEach(c =>
      c.onclick = () => showBrand(c.dataset.bid));
    catOverviewLoaded = true;
...
async function showBrand(bid) {
  ...
  try {
    ...
    document.querySelectorAll('#cat-out [data-del]').forEach(b => b.onclick = async () => {
